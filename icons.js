  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
      ...
      <text x="48" y="62" text-anchor="middle" fill="#2E9E6B"
        font-family="Arial, Helvetica, sans-serif" font-size="33" font-weight="700" letter-spacing="-1">B2B</text></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
      ...
      <rect x="55" y="63" width="9" height="8" rx="2.5" fill="#6D4AE0"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
      ...
      <rect x="68" y="70" width="18" height="6" rx="3" fill="#F2789F"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
      ...
      <circle cx="52" cy="61" r="2.2" fill="#FFFFFF" opacity=".85"/></svg>`
  }
];
